      ...
      <div className="flex justify-center items-center min-h-screen pt-10">
        <div className="grid grid-cols-3 gap-4">
          <div className="relative flex justify-center">
            <figure>
              <Image src="/images/front-getintouch-link.png" alt="get in touch" width={250} height={0} />
            </figure>
          ...
          <div className="col-span-2 relative">
            ...
            <div className="grid grid-cols-3 gap-2 pt-20 px-10">
              <div className="flex justify-center">
                <figure>
                  <Image src="/images/whatwedo-small.png" alt="whatwedo-small" width={130} height={0} className="cursor-pointer" onClick={() => openModal("it@coolish.com")} />
                </figure>
              </div>
              <div className="flex justify-center">
                <figure>
                  <Image src="/images/maintainable-small.png" alt="maintainable-small" width={130} height={0} className="cursor-pointer" onClick={() => openModal("pr@coolish.com")} />
                </figure>
              </div>
              <div className="flex justify-center">
                <figure>
                  <Image src="/images/getintouch-small.png" alt="getintouch-small" width={130} height={0} className="cursor-pointer" onClick={() => openModal("mb@coolish.com")} />
                </figure>
              </div>
              <p className="text-sm font-bold flex justify-center cursor-pointer" onClick={() => openModal("it@coolish.com")}>
                it@coolish.com
              </p>
              <p className="text-sm font-bold flex justify-center cursor-pointer" onClick={() => openModal("pr@coolish.com")}>
                pr@coolish.com
              </p>
              <p className="text-sm font-bold flex justify-center cursor-pointer" onClick={() => openModal("mb@coolish.com")}>
                mb@coolish.com
              </p>
            </div>
